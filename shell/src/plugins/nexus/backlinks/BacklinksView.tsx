  ...
  return (
    <span
      ...
      style={{
        ...
        background: 'var(--interactive-accent-soft, var(--background-secondary))',
  ...
  return (
    <span
      ...
      style={{
        ...
        borderRadius: 999,
        border: '1px solid var(--divider-color)',
        background: isBlock ? 'var(--interactive-accent-soft, var(--background-secondary))' : 'var(--background-secondary)',
        color: 'var(--text-muted)',
        fontSize: 10,
        fontFamily: 'var(--font-monospace)',
        lineHeight: '16px',
