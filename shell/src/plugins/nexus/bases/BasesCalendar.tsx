  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      >
        ...
        <strong style={{ color: 'var(--text-normal, #e4e4e7)' }}>{title}</strong>
        <button
          type="button"
          onClick={() => setMonth(relpath, yyyymm(addMonths(monthStart, 1)))}
          style={toolbarBtnStyle}
        ...
        {cells.map((cell) => {
          ...
          return (
            <div
              ...
              style={{
                ...
                background: cell.inMonth
                  ...
                  : 'var(--background-secondary-alt, #1a1a1d)',
                color: cell.inMonth
                  ? 'var(--text-normal, #e4e4e7)'
            ...
            >
              ...
              {recs.length > 3 && (
                <span style={{ fontSize: 10, color: 'var(--text-faint, #6b7280)' }}>
                  +{recs.length - 3} more
                </span>
              )}
            </div>
