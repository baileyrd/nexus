...
| 09 | Terminal & Process Manager | 🟡 | Phases A–H shipped (`nexus-terminal` crate + `nexus term` CLI + URL detection with localhost-loopback resolution); daemon-backed multi-session registry, env / AI / SQLite persistence still pending |
