...
| 09 | Terminal & Process Manager | 🟡 | Phases A–C shipped (`nexus-terminal` crate: PTY primitive, 10 MB ring buffer, 50-session manager with cap + reap + snapshot); signals / ANSI parsing / env / AI / CLI still pending |
