...
| [BL-143](backlog/BL-143.md) | Phases 1.1+1.2+1.3+1.4 closed | 2026-05-16 | Live collaboration network transport (relay + client bridge + presence + CLI shipped; reconnect / shell UI remain open) |
