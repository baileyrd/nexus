...
> **Phases 1 + 2 closed 2026-05-07** — see [BACKLOG_COMPLETED.md](BACKLOG_COMPLETED.md). Phase 1: pill-shaped editor tabs, ember segmented inspector control, status-bar forge name + ember dot. Phase 2: ember wikilinks (pre-existing), path-style inline code, YAML frontmatter metadata bar. Phases 3–4 remain open (gated on the §5 product decisions Q1 / Q2).
...
**Effort**: Phase 1 ~1 day _(shipped)_ · Phase 2 ~2 days _(shipped)_ · Phase 3 ~3–5 days · Phase 4 ~3–5 days (~3–4 weeks for the lot)
