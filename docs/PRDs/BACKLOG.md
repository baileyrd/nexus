...
>
> **Phases 2b-ii–5 still open:** Phase 2b-ii (AiEvent correlation — runtime subscribes to `com.nexus.ai.stream_*` / `com.nexus.agent.round_*` and republishes typed envelopes), Phase 3 (workflow `async = true`), Phase 4 (indexing-daemon migration), Phase 5 (cancel/pause/resume + `Critical` priority). **Phase 6 (notification router refactor) closed 2026-05-15 via [BL-135](BACKLOG_COMPLETED.md#bl-135-notification-router-refactor--2026-05-15).**
