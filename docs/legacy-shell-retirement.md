...
- The `#[tauri::command]` handler set in `crates/nexus-app/src/lib.rs`
  ...
  on the service crates. `docs/SHELL-COMPARISON.md` (retained as a
...
- `docs/SHELL-COMPARISON.md` — per-command legacy-vs-new map (historical)
- `docs/PHASE-4-IMPLEMENTATION-PLAN.md` §3.2 — the retirement plan
- `docs/PHASE-1-IMPLEMENTATION-PLAN.md` WI-22 — the freeze guardrail
