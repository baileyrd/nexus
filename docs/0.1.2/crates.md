...
| nexus-terminal | lib | Terminal & process manager: PTY, output capture | com.nexus.terminal | nexus-kernel, nexus-plugins, nexus-types | portable-pty, regex-lite, tokio, rusqlite | Yes | ? | PRD-09 foundation; signal handling per OS |
