...
- **Editing & content:** `editor`, `outline`, `paneMode`, `comments`, `crdtConflict`, `templates`, `linkSuggest`, `dailyNotes` (idempotent open-today, prev/next navigation, month-calendar pane — C6 #359)
