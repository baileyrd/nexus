...
> Tracker for "where AI *could* go deeper" — concrete, scoped follow-ups identified by the AI integration analysis on 2026-05-05. Same format as [../roadmap/OPEN-ITEMS.md](../roadmap/OPEN-ITEMS.md). Each item has an ID (`AIG-NN`), severity, surfacing evidence, and a clear definition of done.
>
> Cross-references: [AI-INTERACTION-SURFACE-AUDIT-2026-05-04.md](AI-INTERACTION-SURFACE-AUDIT-2026-05-04.md), [../PRDs/12-ai-engine.md](../PRDs/12-ai-engine.md), [../PRDs/13-skills.md](../PRDs/13-skills.md), [../PRDs/15-agent-system.md](../PRDs/15-agent-system.md), [../PRDs/16-workflow-system.md](../PRDs/16-workflow-system.md).
