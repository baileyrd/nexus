...
| [0032](0032-cooperative-ipc-cancellation.md) | Cooperative IPC cancellation — Track A + Track B | Accepted (Track A shipped) |
| [0033](0033-multi-window-shell-state-serialisation.md) | Multi-window shell-state serialisation (advisory mutex) | Accepted |
| [0034](0034-live-collaboration-transport.md) | Live collaboration network transport — direct WebSocket relay | Accepted (Phase 1–2 shipped) |
| [0035](0035-security-model.md) | Security model — manifest signing, at-rest encryption, TLS pinning, audit logging | Accepted |
