...
- **Visual polish** (Phase 3): icon module ported, layout widths aligned, titlebar cluster shipped — see Phase 3 section. Lazy migration of remaining inline SVGs (files folder + processes grid activity items) is the only loose thread.
