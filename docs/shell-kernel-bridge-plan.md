...
| 11 | `nexus.agent` | `com.nexus.agent::plan/run/history_list/history_get` + `com.nexus.agent.*` topic stream | `paneMode` (full-pane) | forge_orchestrate | _(pending commit)_ paneMode v1 — composer + plan + live step status + history |
