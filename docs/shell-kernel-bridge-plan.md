...
| 17 | `nexus.mcp` | `com.nexus.mcp.host::list_servers/connect/disconnect/list_tools/list_resources/list_prompts/call_tool` | `activityBar`, `sidebarContent`, `overlay` | — | `f7ad739` sidebar v1 + _(pending commit)_ tool-call modal |
