...
This project is indexed by GitNexus as **nexus** (31531 symbols, 58002 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
