...
This project is indexed by GitNexus as **nexus** (32179 symbols, 58384 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
