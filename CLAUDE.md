...
This project is indexed by GitNexus as **nexus** (32613 symbols, 60332 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
